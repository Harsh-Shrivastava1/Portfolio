...
document.addEventListener("DOMContentLoaded", () => {
    ...
    //  Robust smooth scrolling using event delegation (native, no GSAP dependency)
    document.addEventListener('click', function(e) {
        ...
        // Always show navbar after anchor navigation
        const navbarEl = document.querySelector('.navbar');
        if (navbarEl) navbarEl.style.setProperty('transform', 'translateY(0)', 'important');

        // Native smooth scroll with navbar offset (most reliable, no library needed)
